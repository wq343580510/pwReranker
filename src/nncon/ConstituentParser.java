 ...
 * {@link #predict(CoreMap)} on the returned
...
public class ConstituentParser {
   ...
   * {@link GrammaticalRelation} instances.
   */
  ...
  /**
   * Convenience method; see {@link #loadFromModelFile(String, Properties)}.
   *
   * @see #loadFromModelFile(String, Properties)
   */
...
//	    		  System.err.println(c.toString());
   ...
   * <p>
   * This "inner" method returns a structure unique to this package; use {@link #predict(CoreMap)}
