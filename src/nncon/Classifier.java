 ...
 * {@link #Classifier(Config, Dataset, double[][], double[][], double[], double[][], List)}
...
//  	  break;
   ...
   *
   * @throws IllegalStateException If not training
   */
...
/**
   ...
   *
   * @throws IndexOutOfBoundsException (possibly) If
